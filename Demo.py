...
def DrawAns(img, crossPoint, theta):
    ...
    cv2.line(img, (int(crosspoint.x), int(crosspoint.y)), (getAnotherPoint(crossPoint, theta.x), rows), (255,255,105), 5)
    cv2.line(img, (int(crosspoint.x), int(crosspoint.y)), (getAnotherPoint(crossPoint, theta.y), rows), (255,255,105), 5)
    return img
